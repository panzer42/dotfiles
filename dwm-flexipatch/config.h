...
#if BAR_PANGO_PATCH
static const char font[]                 = "Hack 15";
#else
...
static const char *powermenu[] = { "rofi", "-show", "power-menu", "-modi", "power-menu:~/.local/bin/rofi-power-menu", NULL };
